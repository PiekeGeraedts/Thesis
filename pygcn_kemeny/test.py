...
optimizer = optim.Rprop([V], lr=0.1)
...
###Plots###
t = time.time()
save_path = 'tmp/-gammaK_subtract_symmetric_Adam/'
plt.plot(K_lst)
plt.title('Kemeny')
plt.savefig(save_path + '{:.0f}_Kemeny.jpg'.format(t))
plt.show()

plt.plot(K0_lst)
plt.title('Kemeny 0')
plt.savefig(save_path + '{:.0f}_Kemeny0.jpg'.format(t))
plt.show()

plt.plot(K1_lst)
plt.title('Kemeny 1')
plt.savefig(save_path + '{:.0f}_Kemeny1.jpg'.format(t))
plt.show()

plt.plot(nEc_lst)
plt.title('Number of Ergodic Classes')
plt.savefig(save_path + '{:.0f}_nEc.jpg'.format(t))
plt.show()

plt.plot(nTc_lst)
plt.title('Number of Transient Classes')
plt.savefig(save_path + '{:.0f}_nTc.jpg'.format(t))
plt.show()

plt.plot(grad_lst)
plt.title('grad')
plt.savefig(save_path + '{:.0f}_grad.jpg'.format(t))
plt.show()

plt.plot(V_lst)
plt.title('V')
plt.savefig(save_path + '{:.0f}_V.jpg'.format(t))
plt.show()

#This is very similar to the gradient. Only difference is that this is the sum of spsa gradients and grad is the norm of spsa gradients
#plt.plot(loss_lst)
#plt.title('Training Loss')
#plt.savefig(save_path + '{:.0f}_loss.jpg'.format(t))
#plt.show()
