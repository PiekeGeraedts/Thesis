...
path = f'Results/2021/Cora/performanceGCNwithV/{name}_'
print (path)
...
log = np.array([str(date.today()), "nlayers:"+str(args.nlayer), "epochs:"+str(args.epochs)+"+"+str(args.N), "clipper:"+str(args.clipper), "gamma:"+str(gamma), "eps:"+str(eps), eta_info, "projection:" + str(args.projection), "normalisation method:" + str(name), "GCN loss test:" + str(GCN_loss_test), "GCN acc_test:" + str(GCN_acc_test), "loss test:" + str(loss_test), "acc_test:" + str(acc_test)])
